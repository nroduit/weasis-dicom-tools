...
public class CFind {
  ...
  //     * @return The DicomSate instance which contains the DICOM response, the DICOM status, the
  // error message and the
  //     *         progression.
  //     */
  //    public static DicomState process(AdvancedParams params, DicomNode callingNode, DicomNode
  // calledNode,
  //        DicomParam... keys) {
  ...
  //     * @param level
  //     *            specifies retrieve level. Use by default STUDY for PatientRoot, StudyRoot,
  ...
  //                String timeMsg =
  //                    MessageFormat.format("DICOM C-Find connected in {2}ms from {0} to {1}. Query
  // in {3}ms.",
  //                        findSCU.getAAssociateRQ().getCallingAET(),
  // findSCU.getAAssociateRQ().getCalledAET(), t2 - t1,
  //                        t3 - t2);
