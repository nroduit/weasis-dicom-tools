  ...
  public void testProcess() {
    ...
    try {
      ...
      DicomForwardDestination dest =
          new DicomForwardDestination(null, fwdSrcNode, destination, Arrays.asList(editor));
      list.add(dest);
    ...
    // DicomState state = CGetForward.processStudy(params, params, calling2, called, scpNode,
    // progress, studyUID);
